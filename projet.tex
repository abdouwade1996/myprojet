...
\begin{frame} % Use [allowframebreaks] to allow automatic splitting across slides if the content is too long
	...
	\begin{thebibliography}{99} % Beamer does not support BibTeX so references must be inserted manually as below, you may need to use multiple columns and/or reduce the font size further if you have many references
		...
		\bibitem[www.wrytradesman.com/articles/IntroToAgileMethods.pdf]{p1}
		 www.wrytradesman.com/articles/IntroToAgileMethods.pdf
		\bibitem[www.extremeprogramming.org]{p2}
		www.extremeprogramming.org
		\bibitem[www.xprogramming.com/xpmag/whatisxp.htm]{p3}
		www.xprogramming.com/xpmag/whatisxp.htm
		\bibitem[www.selectbs.com/glossary/what-is-extreme-programming.htm]{p4}
		www.selectbs.com/glossary/what-is-extreme-programming.htm
		
		
		\bibitem[ Kenneth E. Kendall]{p2}
